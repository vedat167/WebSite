...
namespace And.Eticaret.UI.WEB.Areas.Admin.Controllers
{
    public class AdminOrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,UserAddressID,StatusID,TotalProductPrice,TotalTextPrice,TotalDiscount,TotalPrice,CreateDate,CreateUserID,UpdateTime,UpdateUserID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,UserAddressID,StatusID,TotalProductPrice,TotalTextPrice,TotalDiscount,TotalPrice,CreateDate,CreateUserID,UpdateTime,UpdateUserID")] Order order)
        {
            if (ModelState.IsValid)
            {
